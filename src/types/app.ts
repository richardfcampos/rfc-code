...
export type AppTab = 'chat' | 'files' | 'shell' | 'git' | 'tasks' | 'browser' | 'collab' | 'board' | 'reviews' | 'team' | `plugin:${string}`;
...
export interface ProjectSession {
  ...
  // Execution worktree of the session when it runs outside the repository
  // root. `worktreeBranch` labels the sidebar badge; when git could not
  // resolve a branch the UI falls back to the basename of `worktreePath`.
