...
function DarkModeToggle({
  ...
  return (
    <button
      ...
      className={cn(
        'relative inline-flex h-7 w-12 flex-shrink-0 touch-manipulation cursor-pointer items-center rounded-full border-2 transition-colors duration-150 ease-out',
    ...
    >
      ...
      <span
        className={cn(
          ...
          isEnabled ? 'translate-x-[22px] bg-primary-foreground' : 'translate-x-[2px] bg-muted-foreground',
        )}
      >
        {isEnabled ? (
