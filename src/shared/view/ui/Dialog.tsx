  ...
  ({ className, children, onEscapeKeyDown, onPointerDownOutside, wrapperClassName, ...props }, ref) => {
    ...
    return createPortal(
      <div className={cn('fixed inset-0 z-50', wrapperClassName)}>
        {/* Overlay */}
        <div
          className="fixed inset-0 animate-dialog-overlay-show bg-[var(--scrim)] backdrop-blur-sm"
          onClick={() => {
        ...
        <div
          ...
          className={cn(
            ...
            'rounded-card border border-border bg-popover text-popover-foreground shadow-[var(--shadow-pop)]',
