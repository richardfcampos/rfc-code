...
function ErrorFallback({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center">
      <div className="max-w-md rounded-card border border-[var(--danger-line)] bg-[var(--danger-tint)] p-6">
        <div className="mb-4 flex items-center">
          ...
          <h3 className="ml-3 text-sm font-medium text-danger">Something went wrong</h3>
        </div>
        <div className="text-sm text-foreground">
          ...
          {showDetails && (
            <details className="mt-4">
              ...
              <pre className="mt-2 max-h-40 overflow-auto rounded-ctl bg-[var(--danger-tint)] p-2 font-mono text-xs">
                {formatError(error)}
                {componentStack}
              </pre>
            </details>
        ...
        <div className="mt-4">
          <button
            ...
            className="rounded-ctl bg-danger px-4 py-2 text-sm text-destructive-foreground transition-colors duration-150 ease-out hover:bg-danger/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-danger"
          >
            Try Again
          </button>
        </div>
