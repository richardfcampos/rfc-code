      ...
      {isLoading ? (
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="mx-auto max-w-md px-6 text-center">
            <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-card bg-muted/50">
            ...
            <div className="rounded-card border border-primary/10 bg-primary/5 p-3.5">
