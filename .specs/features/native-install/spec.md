...
| NAT-5 | Skills empacotadas, agent kit e plugin caveman resolvem para o checkout/`~/.rfc-code` via envs já existentes (`BUNDLED_SKILLS_ROOT`, `AGENT_KIT_ROOT`, `CAVEMAN_PLUGIN_PATH`) — sem paths de imagem Docker |
