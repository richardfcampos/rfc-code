...
| --- | --- | --- | --- |
| Codex SDK in-process (env global) | `server/openai-codex.js:260` | Perfis Codex podem vazar entre sessões concorrentes | Task de verificação; fallback spawn direto do CLI com env isolado |
